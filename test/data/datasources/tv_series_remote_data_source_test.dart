...
void main() {
  ...
  group('get Popular Tv Series', () {
    final tTvSeries = TvSeriesResponse.fromJson(
            jsonDecode(readJson('dummy_data/popular_tv_series.json')))
        .tvList;
  ...
  group('get Top Rated Tv Series', () {
    ...
    test('should return list of tv series when response code is 200 ',
      ...
      // act
      final result = await dataSource.getTopRateTvSeries();
      // assert
      expect(result, tTvSeries);
    });
    ...
    test('should throw ServerException when response code is other than 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY')))
          .thenAnswer((_) async => http.Response('Not Found', 404));
      // act
      final call = dataSource.getTopRateTvSeries();
      // assert
      expect(() => call, throwsA(isA<ServerException>()));
    });
  });
  ...
  group('get tv series detail', () {
    final tId = 1;
    final tTvSeries = TvSeriesDetailModel.fromJson(
