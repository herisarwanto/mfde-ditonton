...
const NOW_PLAYING_TV_SERIES_URL = 'tv/airing_today';
const POPULAR_TV_SERIES_URL = 'tv/popular';
const TOP_RATED_TV_SERIES_URL = 'tv/top_rated';
const TV_SERIES_URL = 'tv';
const SEARCH_TV_SERIES_URL = 'search/tv';

const ADDED_TO_WATCHLIST = 'Added to Watchlist';
const REMOVED_FROM_WATCHLIST = 'Removed from Watchlist';
const FAILED_CONNECT_TO_INTERNET = 'Failed to connect to the network';
